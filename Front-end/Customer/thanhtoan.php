                    ...
                    <div class="form-section">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="firstName" name="fullname" value="<?php echo $row['fullname']; ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="note" name="note" placeholder="Ghi chú..." style="margin-top: 10px;">
                                </div>
                            </div>
